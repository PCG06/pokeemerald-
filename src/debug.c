...
enum FlagsVarsDebugMenu
{
    ...
    DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_TERASTAL,
...
static void DebugAction_FlagsVars_TerastalOnOff(u8 taskId);
...
// Script menu
static const u8 sDebugText_Util_Script_1[] = _("Mega Evo. Battle");
static const u8 sDebugText_Util_Script_2[] = _("Terastal Battle");
...
static const u8 sDebugText_Party_SetUnsetShiny[] =           _("Set/Unset Shiny");
// Flags/Vars Menu
...
static const u8 sDebugText_FlagsVars_ToggleTerastal[] =      _("Toggle {STR_VAR_1}Terastal OFF");
...
static const struct ListMenuItem sDebugMenu_Items_FlagsVars[] =
{
    ...
    [DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_TERASTAL]      = {sDebugText_FlagsVars_ToggleTerastal,     DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_TERASTAL},
...
static void (*const sDebugMenu_Actions_Flags[])(u8) =
{
    ...
    [DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_TERASTAL]      = DebugAction_FlagsVars_TerastalOnOff,
...
static u8 Debug_CheckToggleFlags(u8 id)
{
    ...
    switch (id)
    {
        ...
        case DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_CATCHING:
            ...
            break;
    #endif
    #if B_FLAG_TERA_ORB_NO_COST != 0
        case DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_TERASTAL:
            result = FlagGet(B_FLAG_TERA_ORB_NO_COST);
            break;
    #endif
...
static const u8 sWeatherNames[22][24] = {
    ...
    [WEATHER_BRIGHT_SUN]         = _("BRIGHT SUN"),
    [WEATHER_DOWNPOUR]           = _("DOWNPOUR"),
    [WEATHER_SEVERE_SANDSTORM]   = _("SEVERE SANDSTORM"),
    [WEATHER_BLINDING_SNOW]      = _("BLINDING SNOW"),
...
static void DebugAction_Util_Weather_SelectId(u8 taskId)
{
    if (JOY_NEW(DPAD_ANY))
    {
        ...
        if (gTasks[taskId].tInput <= 18 || gTasks[taskId].tInput >= 20)
...
static void DebugAction_FlagsVars_TerastalOnOff(u8 taskId)
{
    ...
    if (FlagGet(B_FLAG_TERA_ORB_NO_COST))
        ...
        PlaySE(SE_PC_LOGIN);
    FlagToggle(B_FLAG_TERA_ORB_NO_COST);
#endif
}
