...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_CASTBELLE_TOWN:
        return FlagGet(FLAG_VISITED_CASTBELLE_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_SOLA_CITY:
        return FlagGet(FLAG_VISITED_SOLA_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_MISTFALL_CITY:
        return FlagGet(FLAG_VISITED_MISTFALL_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
...
static void CreateFlyDestIcons(void)
{
    ...
    canFlyFlag = FLAG_VISITED_CASTBELLE_TOWN;
