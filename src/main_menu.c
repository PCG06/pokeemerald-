            ...
            DISPLAY_HAS_SAVED_GAME_NOPKMN:
             ...
             case HAS_SAVED_GAME:
                if (CalculatePlayerPartyCount() != 0)
                {
                    ...
                    AddTextPrinterParameterized3(5, 1, 0, 1, sTextColor_Headers, -1, gText_MainMenuContinue);
                    AddTextPrinterParameterized3(6, 1, 0, 0, sTextColor_Headers, -1, gText_MainMenuNewGame);
                    AddTextPrinterParameterized3(7, 1, 0, 1, sTextColor_Headers, -1, gText_MainMenuOption);
...
static void MainMenu_FormatSavegameTime(u8 hasParty)
{
    ...
    AddTextPrinterParameterized3(2 + 3 * hasParty, FONT_NORMAL, 0x6C, 17, sTextColor_MenuInfo, TEXT_SKIP_DRAW, gStringVar4);
    ptr = ConvertIntToDecimalStringN(str, gSaveBlock2Ptr->playTimeHours, STR_CONV_MODE_LEFT_ALIGN, 3);
    *ptr = 0xF0;
    ConvertIntToDecimalStringN(ptr + 1, gSaveBlock2Ptr->playTimeMinutes, STR_CONV_MODE_LEADING_ZEROS, 2);
    AddTextPrinterParameterized3(2 + 3 * hasParty, FONT_NORMAL, GetStringRightAlignXOffset(FONT_NORMAL, str, 0xD0), 17, sTextColor_MenuInfo, TEXT_SKIP_DRAW, str);
}
...
static void MainMenu_FormatSavegamePokedex(void)
{
    ...
    if (FlagGet(FLAG_SYS_POKEDEX_GET) == TRUE)
    {
        ...
        AddTextPrinterParameterized3(5, FONT_NORMAL, 0, 33, sTextColor_MenuInfo, TEXT_SKIP_DRAW, gStringVar4);
        ConvertIntToDecimalStringN(str, dexCount, STR_CONV_MODE_LEFT_ALIGN, 3);
        AddTextPrinterParameterized3(5, FONT_NORMAL, GetStringRightAlignXOffset(FONT_NORMAL, str, 100), 33, sTextColor_MenuInfo, TEXT_SKIP_DRAW, str);
    }
}
...
static void MainMenu_FormatSavegameBadges(void)
{
    ...
    AddTextPrinterParameterized3(5, FONT_NORMAL, 0x6C, 33, sTextColor_MenuInfo, TEXT_SKIP_DRAW, gStringVar4);
    ConvertIntToDecimalStringN(str, badgeCount, STR_CONV_MODE_LEADING_ZEROS, 1);
    AddTextPrinterParameterized3(5, FONT_NORMAL, GetStringRightAlignXOffset(FONT_NORMAL, str, 0xD0), 33, sTextColor_MenuInfo, TEXT_SKIP_DRAW, str);
}
