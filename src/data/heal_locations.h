static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_CASTBELLE_TOWN_PLAYERS_HOUSE_2F - 1] = {MAP_GROUP(CASTBELLE_TOWN_PLAYERS_HOUSE_2F), MAP_NUM(CASTBELLE_TOWN_PLAYERS_HOUSE_2F), 4, 2},
    [HEAL_LOCATION_CASTBELLE_TOWN - 1] = {MAP_GROUP(CASTBELLE_TOWN), MAP_NUM(CASTBELLE_TOWN), 6, 7},
    [HEAL_LOCATION_SOLA_CITY - 1] = {MAP_GROUP(SOLA_CITY), MAP_NUM(SOLA_CITY), 25, 33},
    [HEAL_LOCATION_MISTFALL_CITY - 1] = {MAP_GROUP(MISTFALL_CITY), MAP_NUM(MISTFALL_CITY), 34, 18},
};
