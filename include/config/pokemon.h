...
#define P_FLAG_FORCE_SHINY      0     // If this flag is set, all wild and gift Pokémon will be forced into being Shiny.
#define P_FLAG_FORCE_NO_SHINY   FLAG_SYS_FORCE_NO_SHINY  // If this flag is set, all wild and gift Pokémon will be forced into NOT being Shiny.
#define P_FLAG_FORCE_POKERUS    FLAG_SYS_FORCE_POKERUS   // If this flag is set, all wild and gift Pokémon will be forced into having Pokérus.
