...
#define STATUS_FIELD_METAL_TERRAIN                  (1 << 15)
...
#define B_WEATHER_SUN_PRIMAL              (1 << 7)
#define B_WEATHER_SUN                     (B_WEATHER_SUN_TEMPORARY | B_WEATHER_SUN_PERMANENT | B_WEATHER_SUN_PRIMAL)
#define B_WEATHER_HAIL_TEMPORARY          (1 << 8)
#define B_WEATHER_HAIL_PERMANENT          (1 << 9)
#define B_WEATHER_HAIL                    (B_WEATHER_HAIL_TEMPORARY | B_WEATHER_HAIL_PERMANENT)
#define B_WEATHER_SNOW_TEMPORARY          (1 << 10)
#define B_WEATHER_SNOW_PERMANENT          (1 << 11)
#define B_WEATHER_SNOW                    (B_WEATHER_SNOW_TEMPORARY | B_WEATHER_SNOW_PERMANENT)
#define B_WEATHER_STRONG_WINDS            (1 << 12)
#define B_WEATHER_FOG_TEMPORARY           (1 << 13)
#define B_WEATHER_FOG_PERMANENT           (1 << 14)
...
#define B_WEATHER_PERMANENT_ANY           (B_WEATHER_RAIN_PERMANENT | B_WEATHER_SUN_PERMANENT | B_WEATHER_SANDSTORM_PERMANENT | B_WEATHER_SNOW_PERMANENT)
...
#define ENUM_WEATHER_RAIN_PERMANENT       10
#define ENUM_WEATHER_SUN_PERMANENT        11
#define ENUM_WEATHER_SANDSTORM_PERMANENT  12
#define ENUM_WEATHER_SNOW_PERMANENT       13
...
#define STARTING_STATUS_WEIGHT_ROOM           11 // custom
#define STARTING_STATUS_GRAVITY               12
#define STARTING_STATUS_GRIM_AURA             13 // custom
#define STARTING_STATUS_REFLECT_OPPONENT      14
#define STARTING_STATUS_LIGHTSCREEN_OPPONENT  15
#define STARTING_STATUS_AURORA_VEIL_OPPONENT  16 // both Reflect and Light Screen
