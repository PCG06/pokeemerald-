...
extern const u8 BattleScript_BlockedByPermanentWeatherEnd3[];
extern const u8 BattleScript_BlockedByPermanentWeatherRet[];
...
extern const u8 BattleScript_WeightedTrickRoomEnds[];
extern const u8 BattleScript_GrimAuraTurnDmg[];
extern const u8 BattleScript_GrimAuraEnds[];
...
extern const u8 BattleScript_EffectMetalTerrain[];
